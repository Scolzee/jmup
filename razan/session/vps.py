...
print(JMTHON)
print(ROZ)
print("Cloning Frozen Userbot")
print(ROZ)
os.system("git clone -b bro https://github.com/Scolzee/sbb_b0")
print(JMTHON)
print(ROZ)
print("runing Frozen now")
print(ROZ)
os.chdir("sbb_b0")
...
os.system("CREATE DATABASE Frozen;")
os.system("\q")
os.system("exit")
os.system("EOF")

# database
database_url = f"postgresql://postgres:{password}@localhost:5432/Frozen"
