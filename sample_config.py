...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/Scolzee/jmub")
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/Scolzee/JmPlugins"
    else:
        EXTERNAL_REPO = None
    # فارات الميوزك
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/6cbc627ab2ab84940a615.jpg"
    )
