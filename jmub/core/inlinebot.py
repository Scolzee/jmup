...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧℱ𝓇ℴ𝓏ℯ𝓃ⵧⵧⵧⵧⵧ⍣**\n[𝓕𝓻𝓸𝔃𝓮𝓷 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/vip_780)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**jmub"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/vip_780"),
                )
            ]
            ...
            result = builder.article(
                title="jmub Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب فروزين **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/vip_780"),
                Button.url(
                    "المطور",
                    "t.me/Scolze_WA",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل فروزين من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝓕𝓻𝓸𝔃𝓮𝓷 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/vip_780)",
