...
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس فروزين : 
    ...
    try:
        ch = await jmub(
            functions.channels.CreateChannelRequest(
                title="Frozen HUNTER - صيد فروزين",
                about="This channel to hunt username by - @vip_780 ",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    ...
                    caption="🐊 Frozen the best 🐊\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @vip_780 - @Scolze_WA ❳ ".format(
                ...
                await event.client.send_file(
                    ch,
                    "https://t.me/jmthongif/2",
                    caption="🐊 ℱ𝓇ℴ𝓏ℯ𝓃 the best 🐊\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @vip_780 - @Scolze_WA ❳ ".format(
                        username, trys, choice
                    ),
                )
                await event.client.send_message(
                    "@Scolze_WA", f"- Done : @{username} !\n- By : @Scolze_WA - @vip_780 !"
                )
                sedmod = False
                break
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await jmub(
                functions.channels.CreateChannelRequest(
                    title="ℱ𝓇ℴ𝓏ℯ𝓃 HUNTER - تثبيت فروزين",
                    about="This channel to hunt username by - @vip_780 ",
                )
            )
            ch = ch.updates[1].channel_id
