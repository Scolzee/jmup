...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5340100457:
        await event.client.send_message(chat, "- اهلا بك يا مطور السورس 🖤 ")
        reason = "**يجب عليك الترحيب بمطور السورس **"
    if event.chat_id == 1302893947:
        await event.client.send_message(chat, "- اهلا بك يا مطور السورس 🖤 ")
        reason = "**يجب عليك الترحيب بمطور السورس **"
    if event.chat_id == 5780639901:
        await event.client.send_message(chat, "- اهلا بك يا مرات مطور السورس 🖤 ")
        reason = "**يجب عليك الترحيب بمرات مطور السورس **"
        try:
            PM_WARNS = sql.get_collection("pmwarns").json
        except AttributeError:
            PM_WARNS = {}
...
@jmub.ar_cmd(pattern="الحماية (تشغيل|تعطيل)$")  # ترجمه وكتابة فريق فروزين
